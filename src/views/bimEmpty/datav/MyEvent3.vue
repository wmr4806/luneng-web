...
export default {
  ...
  methods: {
    async cheliang() {
      ...
      this.cheliangshu = parseInt(data.north.totalStopNum) + parseInt(data.south.totalStopNum)
      this.kongyu = parseInt(data.north.totalRemainNum) + parseInt(data.south.totalRemainNum)
      const kongyuchewei = []
      const yiyongchewei = []
