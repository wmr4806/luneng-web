...
export default {
  ...
  data() {
    return {
      // url: 'http://101.132.169.245:90/live?port=1935&app=myTV&stream=TV4',
      url1: '',
      url2: '',
      url3: '',
      url4: '',
  ...
  mounted() {
    this.$nextTick(() => {
      this._getTurnRtspToRtmp('3号楼B3F', url => {
        this.url1 = url
      })
      this._getTurnRtspToRtmp('3号楼B1F', url => {
        this.url2 = url
      })
      this._getTurnRtspToRtmp('4号楼2F', url => {
        this.url3 = url
      })
      this._getTurnRtspToRtmp('4号楼4F', url => {
        this.url4 = url
      })
      let i = 4
